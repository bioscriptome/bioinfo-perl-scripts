...
open(GEN,$GENOME);
open(COD_POS,">$ARGV[1].c_l_p");#output file having codon and its positions
...
$num_co++;
		if($cod_len_pos=~/##/){
				...
				$add1=$co_le_pos[1]/6;
				$add=ceil($add1);print TEMP $co_le_pos[0]."##";
