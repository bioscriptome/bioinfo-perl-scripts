...
foreach $id(@properties){
    ...
    system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $positive >./temp/positve.$id ";
    system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $negative >./temp/negative.$id ";
    if($bp eq '' ||$bn eq ''){}
    else{
	system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $bp >./temp/b_positve.$id ";
	system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $bn >./temp/b_negative.$id ";
      } 
}
