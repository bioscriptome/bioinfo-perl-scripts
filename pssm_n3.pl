#############################################################################
###    'pssm_n3' is free software: you can redistribute it and/or modify      #
...
#=================================================================
# program is developed to normalize pssm profile ( = (numb -min)*100/(max -min)
...
close OUT;
    ...
    print "Usage:perl pssm_n3 -i pssm_col_file -o\tOutputFile\n";
    print "-i\tInput PSSM matrix file (in column format)\n-o\tOutputFile (normalized valued based on '(numb -min)*100/(max -min)' formula)\n";
}
