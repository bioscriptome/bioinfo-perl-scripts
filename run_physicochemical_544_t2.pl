...
$to1="../tempD1_svm_result";
$to2="../tempD3_svm_result";
$to3="../tempD5_svm_result";
...
foreach $id(@properties){
    chomp($id);
    system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $ARGV[0] >positve.$id ";
    system "perl ~/progs/calcPhysicoChemical_avg.pl ~/Matrix/physico/physicochemical_544/$id $ARGV[1] >negative.$id ";
