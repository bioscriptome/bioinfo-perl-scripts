...
$add=($window-1)/2;
#$com=0; 
system "mkdir pos_dis mot bin pos_bin";
system "rm ./mot/$ARGV[1].mot ./pos_dis/$ARGV[1].DIS";
$count=0;
system "rm ./mot/$ARGV[1].mot";
open(MOT,">./mot/$ARGV[1].mot");
open(DIS,">./pos_dis/$ARGV[1].DIS");
...
print $count;
system "perl ~/gpsr_1.0/bin/motif2bin -i ./mot/$ARGV[1].mot -o ./bin/$ARGV[1].bin -x y";
system "paste -d '' ./pos_dis/$ARGV[1].DIS ./bin/$ARGV[1].bin>./pos_bin/$ARGV[1].pos_bin";
}
