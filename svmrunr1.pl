...
#@gg=qw(0.0001 0.0005 0.001 0.003 0.005 0.006 0.01 0.03 0.06 0.1 0.5 1);
#@cc=qw(0.001 0.005 0.01 0.05 0.1 1 10 20 50 100 200 300);

#@gg=qw(0.00001 0.00005 0.00007 0.0001);
#@cc=qw(1 5 10 20 50 100 150 200);
#@gg=qw(0.0001 0.0005 0.001 0.005 0.01 0.05 0.1 0.5 1 5 );                                                                                                 
open(MAJ,">RESULT");
...
for($num=1;$num<11;$num++){
	system "~/progs/sipred_progs/mk/svm_learn -z r -t 0 -c $cc[$y] train_$num.pat model_$num";
       # system "~/progs/sipred_progs/mk/svm_learn -z r -t 1 -d $dd[$y1] train_$num.pat model_$num";
