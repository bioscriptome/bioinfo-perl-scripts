...
foreach $id(@properties){
    chomp($id);
    system "perl ~/progs/physicoChemical.pl ~/Matrix/physico/physicochemical_544/$id $ARGV[0] >positve.$id ";
    system "perl ~/progs/physicoChemical.pl ~/Matrix/physico/physicochemical_544/$id $ARGV[1] >negative.$id ";
