   ...
   for($c1=0;$c1<@c;$c1++)
    {
     for ($t=1;$t<6;$t++)
       {
            system "/media/data/Projects/svmr/nishant/progs/svm_learn -z c -t 0 -c $c[$c1] train_$t model0_c$c[$c1]_$t";
            system "/media/data/Projects/svmr/nishant/progs/svm_classify test_[$t] model0_c$c[$c1]_$t res0_c$c[$c1]_$t";
